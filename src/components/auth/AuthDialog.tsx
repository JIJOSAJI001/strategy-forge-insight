...
import { signInWithEmailAndPassword, createUserWithEmailAndPassword, GoogleAuthProvider, signInWithPopup, updateProfile, updatePassword, deleteUser, sendEmailVerification } from "firebase/auth";
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="bg-card shadow-2xl border-none p-8 max-w-md rounded-2xl">
        <DialogHeader>
          <h2 className="text-2xl font-bold text-center mb-2 text-primary">{tab === "login" ? "Sign in to your account" : "Create your account"}</h2>
          <p className="text-muted-foreground text-center mb-4">Access all features with your account</p>
        </DialogHeader>
        ...
        {user && (
          <div className="mt-8 border-t border-border pt-6">
            ...
            <Button type="button" variant="danger" className="w-full" onClick={handleDeleteAccount} disabled={settingsLoading}>
