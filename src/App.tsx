      ...
      <BrowserRouter>
        <AppLayout>
          <Routes>
            ...
            <Route path="/strategies" element={<div className="p-8 text-center"><h1 className="text-2xl font-bold">Strategy Library</h1><p className="text-muted-foreground">Coming soon...</p></div>} />
            ...
            <Route path="/paper-trading" element={<div className="p-8 text-center"><h1 className="text-2xl font-bold">Paper Trading</h1><p className="text-muted-foreground">Coming soon...</p></div>} />
