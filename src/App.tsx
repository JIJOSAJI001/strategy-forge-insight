        ...
        <BrowserRouter>
          <AppLayout>
            <Routes>
              ...
              <Route path="/strategy-builder" element={<div className="p-8 text-center"><h1 className="text-2xl font-bold">Strategy Builder</h1><p className="text-muted-foreground">Coming soon...</p></div>} />
