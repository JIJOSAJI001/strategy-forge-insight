...
export const MOCK_STRATEGIES: DragDropStrategy[] = [
    {
        id: '1',
    ...
    },
    {
        id: '2',
        name: 'SMA Crossover',
        description: 'Buy when Price > SMA(20)',
        entryConditions: [
            { indicator: 'Price', operator: '>', value: 'SMA', period: 20 } // Simplified
        ],
        exitConditions: [
            { indicator: 'Price', operator: '<', value: 'SMA', period: 20 }
        ]
    }
];
