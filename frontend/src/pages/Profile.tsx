...
import { updatePassword, deleteUser, updateProfile, sendEmailVerification, reauthenticateWithCredential, EmailAuthProvider } from "firebase/auth";
import { 
  User, 
  Mail, 
  Calendar, 
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-background/50 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-medium">{user.emailVerified ? (user.displayName || "No username set") : user.email}</p>
            ...
            <CardContent>
              {!isChangingPassword ? (
                ...
                <form onSubmit={handleChangePassword} className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button type="submit" disabled={loading || !newPassword || !currentPassword || !confirmPassword} className="bg-primary hover:bg-primary/90">
                      {loading ? (
                        <>
                          <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2" />
                          Updating...
